      ...
      <div className={`flex w-full justify-center ${className}`}>
        <div className="flex items-center gap-3 rounded-lg bg-[#183972] px-4 py-3 text-white shadow-lg">
          <Button
            ...
            variant="ghost"
            className="h-10 rounded-lg px-3 text-base font-bold text-white hover:bg-yellow-300 hover:text-[#183972]
             disabled:opacity-40"
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1500px]">
        ...
        <Card className="mx-auto rounded-lg border-slate-200 bg-white/95 p-6 shadow-2xl backdrop-blur-sm sm:p-8 lg:p-10">
            ...
            <div className="flex w-full flex-col gap-4 lg:flex-row">
              <div className="relative w-full lg:flex-[2]">
                ...
                <Input
                  ...
                  className="h-14 w-full rounded-md border-2 border-yellow-400 bg-white pl-12 pr-4 text-base font-semibold 
                  text-[#183972] placeholder:text-slate-400 focus:ring-yellow-300"
                />
              </div>
              ...
              <div className="w-full lg:flex-1">
                <select
                  ...
                  className="h-14 w-full rounded-md border-2 border-yellow-400 bg-white px-4 text-base font-semibold text-[#183972]
              ...
              <div className="w-full lg:flex-1">
                <Input
                  ...
                  className="h-14 w-full rounded-md border-2 border-yellow-400 bg-white px-4 text-base font-semibold 
                  text-[#183972] focus:ring-yellow-300"
          ...
          {visibleEvents.length > 0 ? (
            ...
            <div className="rounded-md border border-dashed border-slate-300 bg-slate-50 p-10 text-center text-base 
